...
1. Install the [Claude in Chrome extension](https://chrome.google.com/webstore/detail/claude-in-chrome/fppbfnjmfonhjgppeejdomedbdfoonjm)
...
3. Follow the prompts to connect the extension
...
- [Getting started with Claude for Chrome](https://claude.com/docs/chrome-extension) - Full documentation for the Chrome extension, including shortcuts, scheduling, and permissions
